...
{
    string badInput; // string fot throwing away invalid input
    string fromSquare = "  ";
    string toSquare = "  ";
    int fromX;
    int fromY;
    ...
    // move must be in algrebraic notation
        ...
        )
    {
        ...
        cin.clear();
        getline(chi, badInput); // take bad input off the stream and ignore it
        cout << _name << " player enter move (e.g. a2 a4): ";
        cin >> fromSquare >> toSquare;
    }
